...
with open("data/zone_vectors.json") as f:
    zone_vectors = json.load(f)

with open("data/state_vectors.json") as f:
    state_vectors = json.load(f)

with open("data/city_vectors.json") as f:
    city_vectors = json.load(f)

with open("data/city_to_state.json") as f:
    city_to_state = json.load(f)

with open("data/state_to_zone.json") as f:
    state_to_zone = json.load(f)

with open("data/preference_model.json") as f:
